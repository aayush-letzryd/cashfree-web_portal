...
gmail_imap_fetch.py
────────────────────────────────────────────────────────────
Poll dhanushaisolutions@gmail.com via IMAP for a recent Ola
statement email with an .xlsx attachment.

Called when GCP cannot do a direct download from the Ola portal
and instead triggers an email export to dhanushaisolutions@gmail.com.
...
OLA_SUBJECT_KEYWORDS = ["statement", "hisaab", "accounting", "settlement", "ola", "report"]
OLA_SENDER_KEYWORDS  = ["ola", "olacabs", "noreply", "no-reply"]
